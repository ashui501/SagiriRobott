...
Sagiri_IMG = ( 
    "https://telegra.ph/file/e9fa9cdfe13717d44bb1d.jpg",
    "https://telegra.ph/file/891a1a77ceadd813b3506.jpg",
    "https://telegra.ph/file/cc82da46e6d687541aa78.jpg",
    "https://telegra.ph/file/3f8b045cf3508c47e519e.jpg",
)
...
𝘔𝘢𝘥𝘦 𝘰𝘯 𝘖𝘭𝘥𝘦𝘳 𝘝𝘦𝘳𝘴𝘪𝘰𝘯 𝘰𝘧 @Gojo_ProXBot
"""
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🎵 ᴍᴜsɪᴄ 🎵", callback_data="Donate_String"),
    ],
    [
...
HELP_STRINGS = f"""
[❃](https://telegra.ph/file/5391d1696decca2621575.jpg)
...
def Sagiri_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "sagiri_":
        ...
        first_name = update.effective_user.first_name 
        query.message.edit_text(
            PM_START_TEXT.format(escape_markdown(first_name), (Sagiri_IMG), BOT_NAME),
            reply_markup=InlineKeyboardMarkup(buttons),
            parse_mode=ParseMode.MARKDOWN,
            timeout=60,
...
def Music_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "Music_":
        query.message.edit_text.reply_photo(
            PHOTO,
            text=f"""
 hey [•](https://te.legra.ph/file/286b712ac144780d3fa12.jpg)
 """,
