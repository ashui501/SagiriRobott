class Config(object):
    ...
    MONGO_DB_URI = ""  # Get this value from cloud.mongodb.com
    ...
    SUPPORT_CHAT = "yamada_support_chat"  # Your Telegram support group chat username where your users will go and bother you
